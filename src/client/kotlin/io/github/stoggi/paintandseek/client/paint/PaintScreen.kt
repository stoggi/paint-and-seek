...
import io.github.stoggi.paintandseek.net.SubmitPose
import io.github.stoggi.paintandseek.net.SubmitSkinPatch
 ...
 */
class PaintScreen : Screen(Component.literal("PaintAndSeek")) {
    ...
    private fun readTexelRgb(texture: GpuTexture, width: Int, px: Int, py: Int, callback: (Int, Int, Int) -> Unit) {
        ...
        val buffer = device.createBuffer({ "paintandseek lightmap read" }, 9, width.toLong() * height * blockSize)
